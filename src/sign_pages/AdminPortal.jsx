...
export default function AdminPortal() {
    ...
    const InsertProduct=(e)=>{
      e.preventDefault();
      axios.post("https://mern-powerlend-website-2.onrender.com/createProduct", {proname, prorate, desc, overview, avail, category, imgurl})
      .then(()=>{
        handleShow2()
      }).catch(err=>console.log(err))
    }
    ...
    const handleDelete=()=>{
      axios.delete("https://mern-powerlend-website-2.onrender.com/deleteProduct/"+deleteproid)
