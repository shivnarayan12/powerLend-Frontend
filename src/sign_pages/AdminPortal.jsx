...
export default function AdminPortal() {
    ...
    useEffect(()=>{
      ...
      if(token!=null){
        axios.get('https://powerlend.onrender.com/getProduct')
    ...
    const InsertProduct=(e)=>{
      e.preventDefault();
      axios.post("https://powerlend.onrender.com/createProduct", {proname, prorate, desc, overview, avail, category, imgurl})
      .then(()=>{
        handleShow2()
      }).catch(err=>console.log(err))
    }
    ...
    const handleDelete=()=>{
      axios.delete("https://powerlend.onrender.com/deleteProduct/"+deleteproid)
