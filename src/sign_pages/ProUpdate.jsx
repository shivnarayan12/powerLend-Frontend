...
export default function ProUpdate() {
  ...
  const {id} = useParams();
    ...
    useEffect(()=>{
      axios.get("https://powerlend.onrender.com/getUp/"+id)
    ...
    const UpPro=(e)=>{
      e.preventDefault();
      axios.put("https://powerlend.onrender.com/updateProduct/"+id, {proname, prorate, desc, overview, avail, category, imgurl})
      .then(()=>{
