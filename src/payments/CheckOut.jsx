...
export default function CheckOut() {
    ...
    const handleOrderPlacement = async () => {
        try {
            const response = await axios.put(`https://mern-powerlend-website-2.onrender.com/update-order-count/${userid}`, {
                orders: 1
            }, {
                headers: {
                    "Content-Type": "application/json",
    ...
    const handlePayment = async () => {
        try {
            const order = await axios.post("https://mern-powerlend-website-2.onrender.com/create-order", {
                amount: total
            }, {
                headers: {
                    "Content-Type": "application/json",
            ...
            const options = {
                ...
                callback_url: "https://mern-powerlend-website-2.onrender.com/verifyPayment", // Update with your server's URL
                prefill: {
                    name: "Shiv Narayan",
    ...
    const handlePaymentSuccess = (response) => {
        ...
        fetch("https://mern-powerlend-website-2.onrender.com/verifyPayment", {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
